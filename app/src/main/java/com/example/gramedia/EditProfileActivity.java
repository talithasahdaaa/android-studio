...
import com.example.gramedia.model.DataPelanggan;
import com.example.gramedia.ui.profile.ProfileFragment;
        ...
        try {
            ...
            api.uploadFoto(emailPart, fotoPart).enqueue(new Callback<ResponseBody>() {
                ...
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    ...
                    try {
                        if (response.isSuccessful() && response.body() != null) {
                            ...
                            Toast.makeText(EditProfileActivity.this, "Gagal mengunggah: " + error, Toast.LENGTH_LONG).show();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                        Toast.makeText(EditProfileActivity.this, "Gagal parsing response", Toast.LENGTH_SHORT).show();
                    }
                }
                ...
                public void onFailure(Call<ResponseBody> call, Throwable t) {
                    progressDialog.dismiss();
                    Toast.makeText(EditProfileActivity.this, "Gagal terhubung: " + t.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(EditProfileActivity.this, "Terjadi kesalahan saat parsing", Toast.LENGTH_SHORT).show();
                }
            }
                ...
                try {
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        if ("1".equals(json.optString("result"))) {
                            ...
                            Toast.makeText(EditProfileActivity.this, "Data profil tidak ditemukan", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                    ...
                    e.printStackTrace();
                    Toast.makeText(EditProfileActivity.this, "Error parsing data profil", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Toast.makeText(EditProfileActivity.this, "Error mengambil profil: " + t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
}
